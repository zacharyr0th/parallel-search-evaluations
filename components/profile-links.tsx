...
const profiles = [
  ...
  [
    "X",
    "https://x.com/zacharyr0th",
    "M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z",
  ],
  [
    "LinkedIn",
    "https://www.linkedin.com/in/zacharyr0th",
    ...
    <>
        {profiles.map(([name, href, path]) => (
          <a
            ...
            rel="noreferrer"
            title={name}
            className="flex size-7 items-center justify-center rounded-full transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-2 focus-visible:outline-ring"
          >
            <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="size-3.5">
              <path d={path} />
            </svg>
            <span className="sr-only">Zachary Roth on {name}</span>
          </a>
        ))}
    </>
  );
